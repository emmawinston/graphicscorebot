{
	"origin":["{svg <?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><svg xmlns:svg=\"http://www.w3.org/2000/svg\" xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"500\" height=\"500\" viewBox=\"0 0 180 180\" style=\"enable-background:new 0 0 180 180;\" id=\"svg2\" xml:space=\"preserve\">#staff# #lines#</svg>}"],
	...
	"line2":["<path d=\"M 0 #digit##digit# q #digit##digit# -#digit##digit# #digit##digit# #digit# q #digit##digit# -#digit##digit# #digit##digit# #digit# \" style=\"fill:none;stroke:\\##color#;stroke-width:#leastone#;stroke-linejoin:round;\"  />"],
